...
LAB87:    if (*((unsigned int *)t269) > 0)
        goto LAB88;

LAB89:    memcpy(t268, t316, 8);
...
LAB92:    *((unsigned int *)t320) = 1;

LAB94:    memset(t317, 0, 8);
    t336 = (t320 + 4);
...
LAB104:    if (*((unsigned int *)t317) > 0)
        goto LAB105;

LAB106:    memcpy(t316, t354, 8);

LAB107:    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t268, 32, t299, 32, t316, 32);
    goto LAB90;

LAB88:    memcpy(t268, t299, 8);
    goto LAB90;
...
LAB101:    t347 = (t0 + 1244U);
    t353 = *((char **)t347);
    t347 = ((char*)((ng2)));
    memset(t354, 0, 8);
    xsi_vlog_unsigned_add(t354, 32, t353, 32, t347, 32);
    goto LAB102;

LAB103:    xsi_vlog_unsigned_bit_combine(t316, 32, t348, 32, t354, 32);
    goto LAB107;

LAB105:    memcpy(t316, t348, 8);
    goto LAB107;

}


extern void work_m_00000000004281343338_0757879789_init()
{
	static char *pe[] = {(void *)Cont_19_0};
	xsi_register_didat("work_m_00000000004281343338_0757879789", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000004281343338_0757879789.didat");
