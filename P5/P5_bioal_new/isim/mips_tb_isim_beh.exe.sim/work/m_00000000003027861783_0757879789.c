...
#endif
static const char *ng0 = "D:/Programing/ComputerOrganization/P5/P5_bioal_new/NPC.v";
...
LAB122:    if (*((unsigned int *)t402) > 0)
        goto LAB123;

LAB124:    memcpy(t401, t449, 8);
...
LAB117:    t433 = ((char*)((ng3)));
    ...
    *((unsigned int *)t436) = t440;
    ...
    t442 = (t441 >> 28);
    *((unsigned int *)t434) = t442;
    t443 = *((unsigned int *)t436);
    *((unsigned int *)t436) = (t443 & 15U);
    t444 = *((unsigned int *)t434);
    *((unsigned int *)t434) = (t444 & 15U);
    xsi_vlogtype_concat(t432, 32, 32, 3U, t436, 4, t435, 26, t433, 2);
    goto LAB118;

LAB119:    t451 = (t0 + 1244U);
    t452 = *((char **)t451);
    t451 = ((char*)((ng1)));
    memset(t453, 0, 8);
    t454 = (t452 + 4);
...
LAB137:    if (*((unsigned int *)t476) > 0)
        goto LAB138;

LAB139:    if (*((unsigned int *)t450) > 0)
        goto LAB140;

LAB141:    memcpy(t449, t487, 8);

LAB142:    goto LAB120;

LAB121:    xsi_vlog_unsigned_bit_combine(t401, 32, t432, 32, t449, 32);
    goto LAB125;

LAB123:    memcpy(t401, t432, 8);
    goto LAB125;
...
LAB134:    t480 = (t0 + 1612U);
    t481 = *((char **)t480);
    goto LAB135;

LAB136:    t480 = (t0 + 1336U);
    t486 = *((char **)t480);
    t480 = ((char*)((ng2)));
    memset(t487, 0, 8);
    xsi_vlog_unsigned_add(t487, 32, t486, 32, t480, 32);
    goto LAB137;

LAB138:    xsi_vlog_unsigned_bit_combine(t449, 32, t481, 32, t487, 32);
    goto LAB142;

LAB140:    memcpy(t449, t481, 8);
    goto LAB142;

}


extern void work_m_00000000003027861783_0757879789_init()
{
	static char *pe[] = {(void *)Cont_20_0};
	xsi_register_didat("work_m_00000000003027861783_0757879789", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000003027861783_0757879789.didat");
