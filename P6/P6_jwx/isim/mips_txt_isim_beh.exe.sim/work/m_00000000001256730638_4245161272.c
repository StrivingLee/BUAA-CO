...
#endif
static const char *ng0 = "D:/Programing/ComputerOrganization/P6/P6_jwx/E_ALU.v";
...
LAB86:    t245 = (t0 + 600U);
    ...
    t248 = *((char **)t245);
    memset(t249, 0, 8);
    xsi_vlog_signed_less(t249, 32, t246, 32, t248, 32);
    t245 = ((char*)((ng1)));
    xsi_vlogtype_concat(t243, 32, 32, 2U, t245, 31, t249, 1);
    goto LAB87;
...
LAB96:    *((unsigned int *)t258) = 1;

LAB98:    memset(t255, 0, 8);
    t274 = (t258 + 4);
...
LAB106:    if (*((unsigned int *)t281) > 0)
        goto LAB107;

LAB108:    if (*((unsigned int *)t255) > 0)
        goto LAB109;

LAB110:    memcpy(t254, t297, 8);

LAB111:    goto LAB89;

LAB90:    xsi_vlog_unsigned_bit_combine(t212, 32, t243, 32, t254, 32);
    goto LAB94;
...
LAB116:    if (*((unsigned int *)t287) < *((unsigned int *)t288))
        goto LAB114;

LAB115:    t292 = ((char*)((ng1)));
    xsi_vlogtype_concat(t285, 32, 32, 2U, t292, 31, t289, 1);
    goto LAB104;

LAB105:    t297 = ((char*)((ng7)));
    goto LAB106;

LAB107:    xsi_vlog_unsigned_bit_combine(t254, 32, t285, 32, t297, 32);
    goto LAB111;

LAB109:    memcpy(t254, t285, 8);
    goto LAB111;
...
extern void work_m_00000000001256730638_4245161272_init()
{
	static char *pe[] = {(void *)Cont_8_0};
	xsi_register_didat("work_m_00000000001256730638_4245161272", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000001256730638_4245161272.didat");
