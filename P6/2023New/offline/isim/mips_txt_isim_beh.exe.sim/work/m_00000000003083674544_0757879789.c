...
#endif
static const char *ng0 = "D:/Programing/BUAA-CO/P6/2023New/offline/NPC.v";
...
LAB38:    t594 = (t0 + 4688);
    ...
    t598 = *((char **)t597);
    memcpy(t598, t3, 8);
    xsi_driver_vfirst_trans(t594, 0, 31);
    t599 = (t0 + 4608);
    *((int *)t599) = 1;
...
LAB30:    t103 = (t0 + 2648U);
    ...
    *((unsigned int *)t120) = t129;
    xsi_vlog_mul_concat(t118, 14, 1, t119, 1U, t122, 1);
    xsi_vlogtype_concat(t106, 32, 32, 3U, t118, 14, t108, 16, t107, 2);
    memset(t130, 0, 8);
    xsi_vlog_unsigned_add(t130, 32, t105, 32, t106, 32);
    goto LAB31;
...
LAB64:    t232 = (t136 + 4);
    t233 = *((unsigned int *)t136);
    t234 = *((unsigned int *)t232);
    t235 = (t233 || t234);
    if (t235 > 0)
        goto LAB65;

LAB66:    t264 = *((unsigned int *)t136);
    t265 = (~(t264));
...
LAB70:    if (*((unsigned int *)t136) > 0)
        goto LAB71;

LAB72:    memcpy(t135, t268, 8);

LAB73:    goto LAB33;

LAB34:    xsi_vlog_unsigned_bit_combine(t3, 32, t130, 32, t135, 32);
    goto LAB38;

LAB36:    memcpy(t3, t130, 8);
    goto LAB38;
...
LAB65:    t236 = (t0 + 2648U);
    ...
    t236 = ((char*)((ng2)));
    memset(t238, 0, 8);
    xsi_vlog_unsigned_add(t238, 32, t237, 32, t236, 32);
    t240 = ((char*)((ng3)));
    t242 = (t0 + 2808U);
    t243 = *((char **)t242);
    memset(t241, 0, 8);
    ...
    *((unsigned int *)t253) = t262;
    xsi_vlog_mul_concat(t251, 14, 1, t252, 1U, t255, 1);
    xsi_vlogtype_concat(t239, 32, 32, 3U, t251, 14, t241, 16, t240, 2);
    memset(t263, 0, 8);
    xsi_vlog_unsigned_add(t263, 32, t238, 32, t239, 32);
    goto LAB66;
...
LAB99:    t365 = (t269 + 4);
    t366 = *((unsigned int *)t269);
    t367 = *((unsigned int *)t365);
    t368 = (t366 || t367);
    if (t368 > 0)
        goto LAB100;

LAB101:    t397 = *((unsigned int *)t269);
    t398 = (~(t397));
...
LAB105:    if (*((unsigned int *)t269) > 0)
        goto LAB106;

LAB107:    memcpy(t268, t401, 8);

LAB108:    goto LAB68;

LAB69:    xsi_vlog_unsigned_bit_combine(t135, 32, t263, 32, t268, 32);
    goto LAB73;

LAB71:    memcpy(t135, t263, 8);
    goto LAB73;
...
LAB100:    t369 = (t0 + 2648U);
    t370 = *((char **)t369);
    t369 = ((char*)((ng2)));
    memset(t371, 0, 8);
    xsi_vlog_unsigned_add(t371, 32, t370, 32, t369, 32);
    t373 = ((char*)((ng3)));
    t375 = (t0 + 2808U);
    t376 = *((char **)t375);
    memset(t374, 0, 8);
    ...
    *((unsigned int *)t374) = (t382 & 65535U);
    t383 = *((unsigned int *)t375);
    *((unsigned int *)t375) = (t383 & 65535U);
    t385 = ((char*)((ng4)));
    t386 = (t0 + 2808U);
    t387 = *((char **)t386);
    memset(t388, 0, 8);
    ...
    *((unsigned int *)t386) = t395;
    xsi_vlog_mul_concat(t384, 14, 1, t385, 1U, t388, 1);
    xsi_vlogtype_concat(t372, 32, 32, 3U, t384, 14, t374, 16, t373, 2);
    memset(t396, 0, 8);
    xsi_vlog_unsigned_add(t396, 32, t371, 32, t372, 32);
    goto LAB101;

LAB102:    t403 = (t0 + 2008U);
    t404 = *((char **)t403);
    t403 = ((char*)((ng1)));
    memset(t405, 0, 8);
    t406 = (t404 + 4);
...
LAB118:    memcpy(t459, t421, 8);

LAB119:    memset(t402, 0, 8);
    t491 = (t459 + 4);
    t492 = *((unsigned int *)t491);
    t493 = (~(t492));
    t494 = *((unsigned int *)t459);
    t495 = (t494 & t493);
    t496 = (t495 & 1U);
    if (t496 != 0)
        goto LAB131;

LAB132:    if (*((unsigned int *)t491) != 0)
        goto LAB133;

LAB134:    t498 = (t402 + 4);
    t499 = *((unsigned int *)t402);
    t500 = *((unsigned int *)t498);
    t501 = (t499 || t500);
    if (t501 > 0)
        goto LAB135;

LAB136:    t504 = *((unsigned int *)t402);
    t505 = (~(t504));
...
LAB140:    if (*((unsigned int *)t402) > 0)
        goto LAB141;

LAB142:    memcpy(t401, t508, 8);

LAB143:    goto LAB103;

LAB104:    xsi_vlog_unsigned_bit_combine(t268, 32, t396, 32, t401, 32);
    goto LAB108;

LAB106:    memcpy(t268, t396, 8);
    goto LAB108;
...
LAB125:    if (*((unsigned int *)t452) != 0)
        goto LAB126;

LAB127:    t460 = *((unsigned int *)t421);
...
LAB128:    t471 = *((unsigned int *)t459);
    t472 = *((unsigned int *)t465);
    *((unsigned int *)t459) = (t471 | t472);
    t473 = (t421 + 4);
    t474 = (t451 + 4);
    t475 = *((unsigned int *)t421);
    t476 = (~(t475));
...
LAB135:    t502 = (t0 + 2968U);
    t503 = *((char **)t502);
    goto LAB136;

LAB137:    t502 = (t0 + 2168U);
    t510 = *((char **)t502);
    t502 = ((char*)((ng1)));
    memset(t511, 0, 8);
    t512 = (t510 + 4);
...
LAB159:    memcpy(t508, t555, 8);

LAB160:    goto LAB138;

LAB139:    xsi_vlog_unsigned_bit_combine(t401, 32, t503, 32, t508, 32);
    goto LAB143;

LAB141:    memcpy(t401, t503, 8);
    goto LAB143;
...
LAB152:    t539 = ((char*)((ng3)));
    ...
    *((unsigned int *)t542) = t546;
    ...
    t548 = (t547 >> 28);
    *((unsigned int *)t540) = t548;
    t549 = *((unsigned int *)t542);
    *((unsigned int *)t542) = (t549 & 15U);
    t550 = *((unsigned int *)t540);
    *((unsigned int *)t540) = (t550 & 15U);
    xsi_vlogtype_concat(t538, 32, 32, 3U, t542, 4, t541, 26, t539, 2);
    goto LAB153;

LAB154:    t557 = (t0 + 2328U);
    t558 = *((char **)t557);
    t557 = ((char*)((ng1)));
    memset(t559, 0, 8);
    t560 = (t558 + 4);
...
LAB162:    *((unsigned int *)t559) = 1;

LAB164:    memset(t556, 0, 8);
    t575 = (t559 + 4);
...
LAB166:    if (*((unsigned int *)t575) != 0)
        goto LAB167;

LAB168:    t582 = (t556 + 4);
    t583 = *((unsigned int *)t556);
    t584 = *((unsigned int *)t582);
    t585 = (t583 || t584);
    if (t585 > 0)
        goto LAB169;

LAB170:    t588 = *((unsigned int *)t556);
    t589 = (~(t588));
...
LAB172:    if (*((unsigned int *)t582) > 0)
        goto LAB173;

LAB174:    if (*((unsigned int *)t556) > 0)
        goto LAB175;

LAB176:    memcpy(t555, t593, 8);

LAB177:    goto LAB155;

LAB156:    xsi_vlog_unsigned_bit_combine(t508, 32, t538, 32, t555, 32);
    goto LAB160;

LAB158:    memcpy(t508, t538, 8);
    goto LAB160;
...
LAB169:    t586 = (t0 + 2968U);
    t587 = *((char **)t586);
    goto LAB170;

LAB171:    t586 = (t0 + 2488U);
    t592 = *((char **)t586);
    t586 = ((char*)((ng2)));
    memset(t593, 0, 8);
    xsi_vlog_unsigned_add(t593, 32, t592, 32, t586, 32);
    goto LAB172;

LAB173:    xsi_vlog_unsigned_bit_combine(t555, 32, t587, 32, t593, 32);
    goto LAB177;

LAB175:    memcpy(t555, t587, 8);
    goto LAB177;

}


extern void work_m_00000000003083674544_0757879789_init()
{
	static char *pe[] = {(void *)Cont_21_0};
	xsi_register_didat("work_m_00000000003083674544_0757879789", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003083674544_0757879789.didat");
