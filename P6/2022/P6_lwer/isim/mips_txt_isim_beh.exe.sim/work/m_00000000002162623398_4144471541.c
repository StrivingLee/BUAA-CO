...
#endif
static const char *ng0 = "D:/Programing/ComputerOrganization/P6/P6_lwer/Controller.v";
...
static void Cont_129_54(char *t0)
{
    char t3[8];
    char t4[8];
    char t7[8];
