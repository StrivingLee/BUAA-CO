...
os.system(
    "java -jar Mars.jar nc mc CompactDataAtZero a dump .text HexText src\code.txt cpu_test.asm")  # 导出指令
os.system("java -jar Mars.jar nc lg mc CompactDataAtZero " + Mars_prj_add + " > std.txt")  # 用Mars运行正确结果
bat.write("cd src\n")
