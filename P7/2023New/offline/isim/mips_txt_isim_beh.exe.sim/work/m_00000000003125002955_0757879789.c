...
#endif
static const char *ng0 = "D:/Programing/BUAA-CO/P7/2023New/offline/NPC.v";
...
LAB56:    t143 = (t0 + 3288U);
    ...
    *((unsigned int *)t160) = t169;
    xsi_vlog_mul_concat(t158, 14, 1, t159, 1U, t162, 1);
    xsi_vlogtype_concat(t146, 32, 32, 3U, t158, 14, t148, 16, t147, 2);
    memset(t170, 0, 8);
    xsi_vlog_unsigned_add(t170, 32, t145, 32, t146, 32);
    goto LAB57;
...
LAB74:    memcpy(t233, t195, 8);

LAB75:    memset(t176, 0, 8);
    t265 = (t233 + 4);
...
LAB94:    if (*((unsigned int *)t272) > 0)
        goto LAB95;

LAB96:    if (*((unsigned int *)t176) > 0)
        goto LAB97;

LAB98:    memcpy(t175, t308, 8);

LAB99:    goto LAB59;

LAB60:    xsi_vlog_unsigned_bit_combine(t42, 32, t170, 32, t175, 32);
    goto LAB64;

LAB62:    memcpy(t42, t170, 8);
    goto LAB64;
...
LAB81:    if (*((unsigned int *)t226) != 0)
        goto LAB82;

LAB83:    t234 = *((unsigned int *)t195);
...
LAB91:    t276 = (t0 + 3288U);
    ...
    *((unsigned int *)t293) = t302;
    xsi_vlog_mul_concat(t291, 14, 1, t292, 1U, t295, 1);
    xsi_vlogtype_concat(t279, 32, 32, 3U, t291, 14, t281, 16, t280, 2);
    memset(t303, 0, 8);
    xsi_vlog_unsigned_add(t303, 32, t278, 32, t279, 32);
    goto LAB92;
...
LAB101:    *((unsigned int *)t312) = 1;

LAB103:    memset(t328, 0, 8);
    t329 = (t312 + 4);
...
LAB125:    t405 = (t309 + 4);
    t406 = *((unsigned int *)t309);
    t407 = *((unsigned int *)t405);
    t408 = (t406 || t407);
    if (t408 > 0)
        goto LAB126;

LAB127:    t437 = *((unsigned int *)t309);
    t438 = (~(t437));
...
LAB129:    if (*((unsigned int *)t405) > 0)
        goto LAB130;

LAB131:    if (*((unsigned int *)t309) > 0)
        goto LAB132;

LAB133:    memcpy(t308, t441, 8);

LAB134:    goto LAB94;

LAB95:    xsi_vlog_unsigned_bit_combine(t175, 32, t303, 32, t308, 32);
    goto LAB99;

LAB97:    memcpy(t175, t303, 8);
    goto LAB99;
...
LAB126:    t409 = (t0 + 3288U);
    t410 = *((char **)t409);
    t409 = ((char*)((ng2)));
    memset(t411, 0, 8);
    xsi_vlog_unsigned_add(t411, 32, t410, 32, t409, 32);
    t413 = ((char*)((ng4)));
    t415 = (t0 + 3448U);
    t416 = *((char **)t415);
    memset(t414, 0, 8);
    ...
    *((unsigned int *)t426) = t435;
    xsi_vlog_mul_concat(t424, 14, 1, t425, 1U, t428, 1);
    xsi_vlogtype_concat(t412, 32, 32, 3U, t424, 14, t414, 16, t413, 2);
    memset(t436, 0, 8);
    xsi_vlog_unsigned_add(t436, 32, t411, 32, t412, 32);
    goto LAB127;

LAB128:    t443 = (t0 + 2648U);
    t444 = *((char **)t443);
    t443 = ((char*)((ng3)));
    memset(t445, 0, 8);
    t446 = (t444 + 4);
...
LAB136:    *((unsigned int *)t445) = 1;

LAB138:    memset(t461, 0, 8);
    t462 = (t445 + 4);
...
LAB144:    memcpy(t499, t461, 8);

LAB145:    memset(t442, 0, 8);
    t531 = (t499 + 4);
...
LAB166:    if (*((unsigned int *)t442) > 0)
        goto LAB167;

LAB168:    memcpy(t441, t548, 8);

LAB169:    goto LAB129;

LAB130:    xsi_vlog_unsigned_bit_combine(t308, 32, t436, 32, t441, 32);
    goto LAB134;

LAB132:    memcpy(t308, t436, 8);
    goto LAB134;
...
LAB147:    *((unsigned int *)t475) = 1;

LAB149:    memset(t491, 0, 8);
    t492 = (t475 + 4);
...
LAB151:    if (*((unsigned int *)t492) != 0)
        goto LAB152;

LAB153:    t500 = *((unsigned int *)t461);
...
LAB161:    t542 = (t0 + 3608U);
    t543 = *((char **)t542);
    goto LAB162;

LAB163:    t542 = (t0 + 2808U);
    t550 = *((char **)t542);
    t542 = ((char*)((ng3)));
    memset(t551, 0, 8);
    t552 = (t550 + 4);
...
LAB181:    if (*((unsigned int *)t574) > 0)
        goto LAB182;

LAB183:    if (*((unsigned int *)t549) > 0)
        goto LAB184;

LAB185:    memcpy(t548, t595, 8);

LAB186:    goto LAB164;

LAB165:    xsi_vlog_unsigned_bit_combine(t441, 32, t543, 32, t548, 32);
    goto LAB169;

LAB167:    memcpy(t441, t543, 8);
    goto LAB169;
...
LAB178:    t579 = ((char*)((ng4)));
    ...
    *((unsigned int *)t582) = t586;
    ...
    t588 = (t587 >> 28);
    *((unsigned int *)t580) = t588;
    t589 = *((unsigned int *)t582);
    *((unsigned int *)t582) = (t589 & 15U);
    t590 = *((unsigned int *)t580);
    *((unsigned int *)t580) = (t590 & 15U);
    xsi_vlogtype_concat(t578, 32, 32, 3U, t582, 4, t581, 26, t579, 2);
    goto LAB179;

LAB180:    t597 = (t0 + 2968U);
    t598 = *((char **)t597);
    t597 = ((char*)((ng3)));
    memset(t599, 0, 8);
    t600 = (t598 + 4);
...
LAB188:    *((unsigned int *)t599) = 1;

LAB190:    memset(t596, 0, 8);
    t615 = (t599 + 4);
    t616 = *((unsigned int *)t615);
    t617 = (~(t616));
    t618 = *((unsigned int *)t599);
    t619 = (t618 & t617);
    t620 = (t619 & 1U);
    if (t620 != 0)
        goto LAB191;
...
LAB194:    t622 = (t596 + 4);
    t623 = *((unsigned int *)t596);
    t624 = *((unsigned int *)t622);
    t625 = (t623 || t624);
    if (t625 > 0)
        goto LAB195;

LAB196:    t628 = *((unsigned int *)t596);
    t629 = (~(t628));
...
LAB198:    if (*((unsigned int *)t622) > 0)
        goto LAB199;

LAB200:    if (*((unsigned int *)t596) > 0)
        goto LAB201;

LAB202:    memcpy(t595, t633, 8);

LAB203:    goto LAB181;

LAB182:    xsi_vlog_unsigned_bit_combine(t548, 32, t578, 32, t595, 32);
    goto LAB186;

LAB184:    memcpy(t548, t578, 8);
    goto LAB186;
...
LAB195:    t626 = (t0 + 3608U);
    t627 = *((char **)t626);
    goto LAB196;

LAB197:    t626 = (t0 + 3128U);
    t632 = *((char **)t626);
    t626 = ((char*)((ng2)));
    memset(t633, 0, 8);
    xsi_vlog_unsigned_add(t633, 32, t632, 32, t626, 32);
    goto LAB198;

LAB199:    xsi_vlog_unsigned_bit_combine(t595, 32, t627, 32, t633, 32);
    goto LAB203;

LAB201:    memcpy(t595, t627, 8);
    goto LAB203;

}


extern void work_m_00000000003125002955_0757879789_init()
{
	static char *pe[] = {(void *)Cont_28_0};
	xsi_register_didat("work_m_00000000003125002955_0757879789", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003125002955_0757879789.didat");
